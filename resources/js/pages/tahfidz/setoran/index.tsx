                                        ...
                                        <tr key={setoran.id}>
                                            ...
                                            <td className="border border-gray-300 px-4 py-2">
                                                ...
                                                {setoran.persentase_target && (
                                                    <div className="mt-1 text-xs text-gray-600">{setoran.persentase_target}%</div>
                                                )}
                                                {/* Debug info */}
                                                <div className="mt-1 text-xs text-gray-500">
                                                    Target:{' '}
                                                    {setoran.target
                                                        ? `Surah ${setoran.target.surah_start}:${setoran.target.ayah_start}-${setoran.target.ayah_end}`
                                                        : 'None'}
                                                </div>
                                            </td>
                                            <td className="border border-gray-300 px-4 py-2">
                                                <Badge className={getStatusColor(setoran.status)}>{getStatusText(setoran.status)}</Badge>
                                            </td>
