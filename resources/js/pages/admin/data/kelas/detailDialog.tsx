...
export default function DetailDialog({ detailData, onClose }: DetailDialogProps) {
    ...
    return (
        ...
        >
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Detail Kelas: {detailData.nama_kelas}</DialogTitle>
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <div className="flex">
                        ...
                        <span>{detailData.nama_kelas}</span>
                    </div>

                    {/* Wali kelas */}
                    <div className="flex">
                        <span className="w-32 pr-2 text-right font-medium">Wali Kelas</span>
                        <span>{detailData.walikelas?.user?.name ?? '-'}</span>
                    </div>
