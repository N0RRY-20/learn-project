...
import { BreadcrumbItem, PageProps, Student, Teacher } from '@/types'; // Pastikan tipe Student sudah ada
...
export default function Create({ students, teachers }: CreateProps) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('datakelas.store')); // Sesuaikan dengan route Anda
    };
                ...
                <form onSubmit={submit} className="flex flex-col gap-6">
                    ...
                    <div className="grid gap-2">
                        ...
                        <select
                            ...
                            onChange={(e) => setData('waliKelas_id', e.target.value)}
                            required
                            tabIndex={2}
